...
class Doublemonitoring extends Component {
    ...
    initalECharts() {
        ...
        const data1 = [
            { name: '黑龙江', area: '东北大区', type: 'areaCenterCity', value: 41 },
            { name: '吉林', area: '东北大区', type: 'areaCenterCity', value: 27 },
            { name: '辽宁', area: '东北大区', type: 'areaCenterCity', value: 51 },
            { name: '内蒙古', area: '其他', type: 'areaCenterCity', value: 37 },
            { name: '北京', area: '华北大区', type: 'areaCenterCity', value: 25 },
            { name: '天津', area: '华北大区', type: 'areaCenterCity', value: 26 },
            { name: '河北', area: '华北大区', type: 'areaCenterCity', value: 64 },
            { name: '山东', area: '华北大区', type: 'areaCenterCity', value: 82 },
            { name: '山西', area: '华北大区', type: 'areaCenterCity', value: 51 },
            { name: '江苏', area: '华东大区', type: 'areaCenterCity', value: 89 },
            { name: '上海', area: '华东大区', type: 'areaCenterCity', value: 23 },
            { name: '浙江', area: '华东大区', type: 'areaCenterCity', value: 49  },
            { name: '福建', area: '华南大区', type: 'areaCenterCity', value: 50  },
            { name: '广东', area: '华南大区', type: 'areaCenterCity', value: 87 },
            { name: '海南', area: '华南大区', type: 'areaCenterCity', value: 13  },
            ...
            { name: '河南', area: '华北大区', type: 'areaCenterCity', value: 94  },
            { name: '安徽', area: '华中大区', type: 'areaCenterCity', value: 74  },
            { name: '江西', area: '华中大区', type: 'areaCenterCity', value: 60  },
            { name: '广东', area: '华南大区', type: 'areaCenterCity', value: 87 },
            { name: '陕西', area: '华西大区', type: 'areaCenterCity', value: 39  },
            { name: '湖北', area: '华中大区', type: 'areaCenterCity', value: 61  },
            { name: '湖南', area: '华中大区', type: 'areaCenterCity', value: 76  },
            { name: '广西', area: '华南大区', type: 'areaCenterCity', value: 44  },
            { name: '宁夏', area: '华西大区', type: 'areaCenterCity', value: 12  },
            { name: '重庆', area: '华西大区', type: 'areaCenterCity', value: 42  },
            { name: '贵州', area: '华西大区', type: 'areaCenterCity', value: 46  },
            { name: '四川', area: '华西大区', type: 'areaCenterCity', value: 79 },
            { name: '云南', area: '华西大区', type: 'areaCenterCity', value: 50 },
            { name: '甘肃', area: '华西大区', type: 'areaCenterCity', value: 28  },
            { name: '青海', area: '其他', type: 'areaCenterCity', value: 8  },
            { name: '西藏', area: '其他', type: 'areaCenterCity', value: 3  },
            { name: '新疆', area: '其他', type: 'areaCenterCity', value: 37  },
            ...
            tooltip: {
                ...
                formatter(params, ticket, callback) {
                    ...
                    tipHtml = '<div class="maptit">' +
                        ...
                        '<p class="h6">'+"高职院校："+  params.value+' </p>' +
                        '</div>';
                    return tipHtml;
                },
            ...
            <div>
                <div className='Collegescenter-banner'>
                    <div className='Common-content'>
                        <h2 className='detail-banner-name'>高职院校 <span  className='crumbs-menu'><Link to="/schoolspace/vocational">首页</Link> / <Link to="/schoolspace/vocational">高职院校</Link> /高职院校分布图</span></h2>
                    </div>
                </div>

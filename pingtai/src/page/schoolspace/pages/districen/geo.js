const provienceData = [
    ...
    { name: '福建', area: '华南大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '广东', area: '华南大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000) },
    { name: '海南', area: '华南大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '台湾', area: '其他', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '香港', area: '其他', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000) },
    { name: '澳门', area: '其他', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '河南', area: '华北大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '安徽', area: '华中大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '江西', area: '华中大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '广东', area: '华南大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000) },
    { name: '陕西', area: '华西大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '湖北', area: '华中大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '湖南', area: '华中大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '广西', area: '华南大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '宁夏', area: '华西大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '重庆', area: '华西大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '贵州', area: '华西大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '四川', area: '华西大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000) },
    { name: '云南', area: '华西大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000) },
    { name: '甘肃', area: '华西大区', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '青海', area: '其他', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '西藏', area: '其他', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  },
    { name: '新疆', area: '其他', type: 'areaCenterCity', InValue: Math.round(Math.random()*1000)  }
];
